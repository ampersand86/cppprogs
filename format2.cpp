...
int main()
{
	...
	cout << setprecision(2) << showpoint << fixed; //can't just use setprecision. showpoint will always print decimal with 2 to the right. fixed will print in fixed notation no matter what. only once needed. setw is only repeated.
	cout << "num1 formatted as a money amount is:  $" << num1 << endl; //what if you want to reset formatting? resetioflags or setprecision 20
